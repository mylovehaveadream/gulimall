package com.guigu.gulimall.ssoclient.controller;
...
public class HelloController {
    ...
    public String employees(Model model, HttpSession session,
        ...
        if(loginUser == null){
            ...
            //跳转过去以后，使用url上的查询参数表示我们自己是哪个页面redirect_url=http://client1.com:8081/employees
            //登录成功后，跳回来告诉登录服务器要跳回到哪里
